...
LogisticRegression::LogisticRegression(Dataset &dataset, int MAX_ITER) :
        Classifier(dataset), classes(dataset.getClasses()) {
    this->MAX_ITER = MAX_ITER;
    train();
}

LogisticRegression::LogisticRegression(Dataset &dataset, std::vector<Class> &classes, int MAX_ITER) :
